...
//	private String id;
	// private Map<String, Object> diagramPoint;
	 ...
	 * @param _model
	 */
	public DLProfileModel(Model _model)
	{
	...
	public String[] get_ObjectPoint(Resource _subject, String _sequence)
	{
		...
		while (!found && it.hasNext())
		{
			...
			if (rdfresourceObject.equals(rdfidObject) && sequenceNumber.equals(_sequence)) {
				diagramPoint[0] = attTag.getProperty(attX).getLiteral()
						.toString();
				diagramPoint[1] = attTag.getProperty(attY).getLiteral()
						.toString();
				found = true;
			}
