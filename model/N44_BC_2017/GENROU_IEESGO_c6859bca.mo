model GENROU_IEESGO_c6859bca "annotation ()"
	...
	OpenIPSL.Electrical.Machines.PSSE.GENROU sm_7000_6 (S_b=1000,M_b=1278,V_b=420,V_0=420,angle_0=11.5945,P_0=-707.429,Q_0=-51.637,R_a=0,Xl=0.16875,H=5.5,D=0,S10=0.1089,S12=0.37795,Tpd0=10,Tpq0=1,Tppd0=0.05,Tppq0=0.05,Xd=2.22,Xpd=0.36,Xppd=0.225,Xq=2.13,Xpq=0.468,Xppq=0) "something here" annotation ();
