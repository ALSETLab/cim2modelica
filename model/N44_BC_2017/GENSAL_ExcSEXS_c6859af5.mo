model GENSAL_ExcSEXS_c6859af5 "annotation ()"
	...
	OpenIPSL.Electrical.Machines.PSSE.GENSAL sm_5400_1 (S_b=1000,M_b=1225,V_b=300,V_0=302.1,angle_0=20.438,P_0=-333.242,Q_0=-227.241,R_a=0,Xl=0.13,H=4.1,D=0,S10=0.1,S12=0.3,Tpd0=6.5,Tppd0=0.05,Tppq0=0.15,Xd=1.02,Xpd=0.25,Xppd=0.16,Xq=0.63,Xppq=0) "something here" annotation ();
