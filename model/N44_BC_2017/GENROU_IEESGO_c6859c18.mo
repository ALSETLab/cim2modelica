model GENROU_IEESGO_c6859c18 "annotation ()"
	...
	OpenIPSL.Electrical.Machines.PSSE.GENROU sm_8500_5 (S_b=1000,M_b=1300,V_b=420,V_0=428.4,angle_0=-3.9983,P_0=-169.333,Q_0=-157.431,R_a=0,Xl=0.14812,H=7,D=0,S10=0.1089,S12=0.37795,Tpd0=10,Tpq0=1,Tppd0=0.05,Tppq0=0.05,Xd=2.42,Xpd=0.23,Xppd=0.17062,Xq=2,Xpq=0.4108,Xppq=0) "something here" annotation ();
