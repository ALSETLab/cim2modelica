model GENSAL_HYGOV_c6859a17 "annotation ()"
	...
	OpenIPSL.Electrical.Machines.PSSE.GENSAL sm_3115_4 (S_b=1000,M_b=1100,V_b=420,V_0=420,angle_0=6.571,P_0=-316.4,Q_0=65.747,R_a=0,Xl=0.11077,H=4.741,D=0,S10=0.10239,S12=0.2742,Tpd0=7.57,Tppd0=0.045,Tppq0=0.1,Xd=0.946,Xpd=0.29,Xppd=0.23,Xq=0.565,Xppq=0) "something here" annotation ();
