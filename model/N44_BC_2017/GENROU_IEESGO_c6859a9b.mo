model GENROU_IEESGO_c6859a9b "annotation ()"
	...
	OpenIPSL.Electrical.Machines.PSSE.GENROU sm_3359_2 (S_b=1000,M_b=1350,V_b=420,V_0=420,angle_0=-0.7323,P_0=-698.949,Q_0=-269.075,R_a=0,Xl=0.14531,H=4.82,D=0,S10=0.1089,S12=0.37795,Tpd0=4.75,Tpq0=1,Tppd0=0.05,Tppq0=0.05,Xd=2.13,Xpd=0.31,Xppd=0.1937,Xq=2.03,Xpq=0.403,Xppq=0) "something here" annotation ();
