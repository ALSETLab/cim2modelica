model GENROU_IEESGO_c6859a85 "annotation ()"
	...
	OpenIPSL.Electrical.Machines.PSSE.GENROU sm_3300_5 (S_b=1000,M_b=1100,V_b=420,V_0=420,angle_0=0,P_0=-704.102,Q_0=-29.633,R_a=0,Xl=0.14812,H=6,D=0,S10=0.1089,S12=0.37795,Tpd0=10.8,Tpq0=1,Tppd0=0.05,Tppq0=0.05,Xd=2.42,Xpd=0.23,Xppd=0.16,Xq=2,Xpq=0.4108,Xppq=0) "something here" annotation ();
