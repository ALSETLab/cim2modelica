model GENSAL_ExcSEXS_c6859b3d "annotation ()"
	...
	OpenIPSL.Electrical.Machines.PSSE.GENSAL sm_6000_3 (S_b=1000,M_b=680,V_b=300,V_0=301.5,angle_0=24.0686,P_0=-429.844,Q_0=-15.552,R_a=0,Xl=0.2,H=3.5,D=0,S10=0.1,S12=0.3,Tpd0=9.7,Tppd0=0.05,Tppq0=0.15,Xd=1.28,Xpd=0.37,Xppd=0.28,Xq=0.94,Xppq=0) "something here" annotation ();
