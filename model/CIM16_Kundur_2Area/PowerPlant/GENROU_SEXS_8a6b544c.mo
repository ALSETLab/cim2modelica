...
model GENROU_SEXS_8a6b544c "annotation ()"
	...
	OpenIPSL.Electrical.Controls.PSSE.ES.SEXS es_SEXS (T_AT_B=1,T_B=1,K=200,T_E=0.1,E_MIN=0,E_MAX=4) "automatically generated comment" annotation (Placement(transformation(extent={{30,-40},{50,-20}})));
