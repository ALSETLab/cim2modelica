...
model GENSAL_ExcSEXS_c6859ac1 "annotation ()"
	OpenIPSL.Interfaces.PwPin plantaPin"automatically generated comment" annotation ();
	OpenIPSL.Electrical.Machines.PSSE.GENSAL sm_5100_2 (S_b=1000,M_b=1200,V_b=300,V_0=300,angle_0=11.5126,P_0=-351.755,Q_0=-435.537,R_a=0.000001,Xl=0.1341,H=3.9871,D=0,S10=0.1,S12=0.3,Tpd0=4.9629,Tppd0=0.05,Tppq0=0.15,Xd=1.1332,Xpd=0.243,Xppd=0.1514,Xq=0.6832,Xppq=0.000001) "automatically generated comment" annotation (Placement(transformation(extent={{30,-40},{50,-20}})));
...
equation
	connect(sm_5100_2.EFD0, es_SEXS.EFD0);
	connect(sm_5100_2.ETERM, es_SEXS.ECOMP);
	connect(es_SEXS.EFD, sm_5100_2.EFD);
	connect(sm_5100_2.SPEED, tgov_HYGOV.SPEED);
	connect(sm_5100_2.PMECH0, tgov_HYGOV.PMECH0);
	connect(sm_5100_2.PMECH, tgov_HYGOV.PMECH);
	connect(sm_5100_2.p, plantaPin);
	connect(const.y, es_SEXS.VOTHSG);
	connect(const.y, es_SEXS.VUEL);
	connect(const.y, es_SEXS.VOEL);
	connect(const.y, es_SEXS.XADIFD);
end GENSAL_ExcSEXS_c6859ac1;