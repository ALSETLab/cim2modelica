model GENSAL_HYGOV_c6859ae5 "annotation ()"
	...
	OpenIPSL.Electrical.Machines.PSSE.GENSAL sm_5300_5 (S_b=1000,M_b=1200,V_b=300,V_0=300,angle_0=43.807,P_0=-723.333,Q_0=-203.805,R_a=0,Xl=0.2,H=3.5,D=0,S10=0.1,S12=0.3,Tpd0=6.4,Tppd0=0.05,Tppq0=0.15,Xd=1.14,Xpd=0.34,Xppd=0.26,Xq=0.84,Xppq=0) "automatically generated comment" annotation ();
