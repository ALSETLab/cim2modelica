model GENSAL_HYGOV_c6859b63 "annotation ()"
	...
	OpenIPSL.Electrical.Machines.PSSE.GENSAL sm_6100_5 (S_b=1000,M_b=1240,V_b=300,V_0=300,angle_0=51.9125,P_0=-628.821,Q_0=-132.332,R_a=0,Xl=0.15,H=3,D=0,S10=0.1,S12=0.3,Tpd0=9.9,Tppd0=0.05,Tppq0=0.15,Xd=1.2,Xpd=0.37,Xppd=0.18,Xq=0.73,Xppq=0) "automatically generated comment" annotation ();
