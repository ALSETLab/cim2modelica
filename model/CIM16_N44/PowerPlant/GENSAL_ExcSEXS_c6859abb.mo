...
model GENSAL_ExcSEXS_c6859abb "annotation ()"
	...
	OpenIPSL.Electrical.Machines.PSSE.GENSAL sm_5100_1 (S_b=1000,M_b=1200,V_b=300,V_0=300,angle_0=11.5126,P_0=-351.755,Q_0=-435.537,R_a=0.000001,Xl=0.13405,H=3.9871,D=0,S10=0.1,S12=0.3,Tpd0=4.9629,Tppd0=0.05,Tppq0=0.15,Xd=1.1332,Xpd=0.24302,Xppd=0.15135,Xq=0.68315,Xppq=0.000001) "automatically generated comment" annotation (Placement(transformation(extent={{30,-40},{50,-20}})));
...
equation
	...
	connect(sm_5100_1.SPEED, tgov_HYGOV.SPEED);
	connect(sm_5100_1.PMECH0, tgov_HYGOV.PMECH0);
	connect(sm_5100_1.PMECH, tgov_HYGOV.PMECH);
