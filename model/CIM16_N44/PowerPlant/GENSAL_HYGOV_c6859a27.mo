...
model GENSAL_HYGOV_c6859a27 "annotation ()"
	...
	OpenIPSL.Electrical.Machines.PSSE.GENSAL sm_3245_1 (S_b=1000,M_b=950,V_b=420,V_0=420,angle_0=-4.2395,P_0=-200.27,Q_0=24.521,R_a=0.000001,Xl=0.11538,H=3.3,D=0,S10=0.10239,S12=0.2742,Tpd0=5,Tppd0=0.06,Tppq0=0.1,Xd=0.75,Xpd=0.25,Xppd=0.15385,Xq=0.5,Xppq=0.000001) "automatically generated comment" annotation (Placement(transformation(extent={{30,-40},{50,-20}})));
