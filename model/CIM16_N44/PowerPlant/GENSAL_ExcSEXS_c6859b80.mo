...
equation
	connect(sm_6500_4.EFD0, es_SEXS.EFD0);
	connect(sm_6500_4.ETERM, es_SEXS.ECOMP);
	connect(es_SEXS.EFD, sm_6500_4.EFD);
	connect(sm_6500_4.SPEED, tgov_HYGOV.SPEED);
	connect(sm_6500_4.PMECH0, tgov_HYGOV.PMECH0);
	connect(sm_6500_4.PMECH, tgov_HYGOV.PMECH);
	connect(sm_6500_4.p, plantaPin);
	connect(const.y, es_SEXS.VOTHSG);
	connect(const.y, es_SEXS.VUEL);
	connect(const.y, es_SEXS.VOEL);
	connect(const.y, es_SEXS.XADIFD);
end GENSAL_ExcSEXS_c6859b80;