model CIM_SMIB "something here"
	...
	OpenIPSL.Electrical.Loads.PSSE.Load Ld1 (angle_0=8.550200462341309,V_0=253.54049682617188,P_0=0,Q_0=0) "something here" annotation ();
